...
class ProfileLTG extends StatefulWidget {

  @override
  _ProfileLTGState createState() => _ProfileLTGState();
}

class _ProfileLTGState extends State<ProfileLTG> {
        ...
        padding: EdgeInsets.all(15),
          ...
          TextButton(
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => InfoPersonnelLTG()),
              );
            },
            child: Padding(
              padding: EdgeInsets.all(15),
